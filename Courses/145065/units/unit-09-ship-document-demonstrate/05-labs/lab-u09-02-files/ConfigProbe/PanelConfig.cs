// COPIED UNCHANGED from the course's Line 3 HMI reference panel (Line3.Hmi.Core/PanelConfig.cs)
// for Lab U09-02. This is the loader a version 1.0.0 panel runs. Do not edit it in Part 1.
//
    ...
    string Reason)
{
    ...
    {
        if (Low is double low && value < low)
        {
            return LimitCheck.BelowLow;
        }

        if (High is double high && value > high)
        {
            return LimitCheck.AboveHigh;
        }
